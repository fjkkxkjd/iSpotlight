...
train_dataset = Dataset("translation_dataset/train.txt", transform=transform)
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)
test_dataset = Dataset("translation_dataset/test.txt", transform=transform)
